    ...
    const fetchData = async () => {
      try {
        ...
        const [evaluationsResponse, matchesResponse] = await Promise.all([
          axios.get(`https://api-noob-react.onrender.com/api/avaliacoes/`, config),
          axios.get(`https://api-noob-react.onrender.com/api/partidas/`, config),
        ]);
        ...
        const totalAverage = evaluations.reduce((acc: number, curr: any) => acc + curr.nota, 0) / evaluations.length;
